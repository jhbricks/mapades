...
with t2:
    ...
    st.markdown("""**:light-blue[Desigualdade]:** atributo de elementos distintos; dessemelhança; diferença; disparidade. No contexto de uma sociedade, a desigualdade social é a relação
    de diferença de distribuição de bens, status e oportunidades entre pessoas ou grupos.""")
    st.markdown("""**:light-blue[Igualdade]:** valor ou importância equivalente. No entanto, quando
    essa igualdade não leva em consideração as diferenças entre pessoas, grupos e sistemas,
    ela pode perpetuar injustiças.""")
    st.markdown("""**:light-blue[Equidade]:**  adaptação da norma geral de igualdade a situações
    ...
    st.markdown("""**:light-blue[Renda]:** Fluxo anual de ganhos de um indivíduo proveniente de todos os recursos disponíveis,
    ...
    juros.""")
    st.markdown("""**:light-blue[Riqueza]:** A soma dos ativos que um indivíduo possui, incluindo bens imóveis, títulos financeiros,
    ...
    st.markdown("""**:light-blue[Índice de Gini]:** Utilizado como medida de desigualdade. O índice varia de 0 (perfeita igualdade) a 1
