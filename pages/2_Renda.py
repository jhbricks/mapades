...
if area == "Paraná":
  ...
  with t2:
    ...
    with c2:
      ...
      st.markdown(f"<p style='line-height: 0.7;'><font size='+5'> Média: {media} </font></p>", unsafe_allow_html=True)
      st.markdown(f"<p style='font-weight: bold; font-size: 1.5em;'>Média: {media}</p>", unsafe_allow_html=True)
