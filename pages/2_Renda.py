...
if area == "Paraná":
  ...
  with t2:
    ...
    with c2:
      ...
      st.markdown("<h3><font size='+5'> Média do Coeficiente de Gini no Paraná:, unsafe_allow_html= True)
      st.markdown(f"<p style='font-weight: bold; font-size: 1.7em;'>{media}</p>", unsafe_allow_html=True)
