...
# Use st.markdown para exibir a imagem como um link clicável
    ...
    st.markdown(f"""<a href="{link3}" target="_self"><img src="data:image/png;base64,{img_b3}" width="200"></a>""",unsafe_allow_html=True)
...
with d:
    ...
    st.markdown(f"""<a href="{link7}" target="_self"><img src="data:image/png;base64,{img_b7}" width="200"></a>""",unsafe_allow_html=True)
