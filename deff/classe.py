...
# valores das classes
    if method in methods:
        ...
        if GVF < 80:
            st.markdown(f"<p> <font style='font-weight: bold; color='red'><font size='+5'> GVF = {GVF} </font> %</font></p>",unsafe_allow_html=True)
        else:
            st.markdown(f"<p><font style='font-weight: bold;'><font size='+5'> GVF = {GVF} </font> %</font></p>",unsafe_allow_html=True)
