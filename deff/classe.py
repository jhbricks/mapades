...
# valores das classes
    if method in methods:
        ...
        if GVF < 80:
            st.markdown(f"<p> <font weight: bold><font color='red'><font size='+5'> GVF = {GVF} </font></p>",unsafe_allow_html=True)
        else:
            st.markdown(f"<p><font weight: bold><font size='+5'> GVF = {GVF} </font></p>",unsafe_allow_html=True)
